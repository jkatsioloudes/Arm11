...
#include "../instructions/instruction/instruction.h"
#include "../instructions/branch/branch.h"
#include "../instructions/dataProcessing/dataProcessing.h"
#include "../instructions/multiply/multiply.h"
#include "../instructions/singleDataTransfer/singleDataTransfer.h"
